...
- `informe-seguimiento` — Genera un Word (.docx) de seguimiento de instalación o persona con los capítulos estándar de Jarmauto (proactividad comercial, digital, calidad, procesos, recursos generales, tareas pendientes), destacando positivos y puntos a mejorar. Una vez revisado el Word, genera también versión HTML y Excel leyendo el Word como fuente de datos. Flujo obligatorio: Word primero, HTML y Excel después.
